...
from Common.function_version_iteration.dyna_nn.v2_TentativeGD.NNFrameWorkV2 import NNFrameWorkV2, cpu, gpu
...
def dyna_train_tsgd(net, a1, a2, hidden_size, data_iter, lr, epochs, x_to_fit, y_to_fit):
    """
    动态训练神经网络
    :param net: 网络
    :param a1: 激活函数1
    ...
    """
    net.add_layer(hidden_size, a1, a2)
    net.set_step_optimizer_tsgd(lr_start=lr)
    net.train_fixed(data_iter, epochs=epochs, plot_hist=True)
    plot_fitting_result(net, x_to_fit, y_to_fit)
    return net.loss_history[-1]
